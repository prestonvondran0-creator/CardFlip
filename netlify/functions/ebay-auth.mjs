...
// ?action=login   -> redirects you to eBay's consent screen
// (eBay redirects back here with ?code=...) -> exchanges code for tokens, stores them
// ?action=logout  -> clears stored tokens
import { TOKEN_URL, SCOPES, saveTokens, clearTokens, exchangeBasicAuth } from "../../ebay-lib.mjs";
